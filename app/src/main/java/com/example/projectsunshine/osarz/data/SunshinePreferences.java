 ...
 */
package com.example.projectsunshine.osarz.data;
...
public class SunshinePreferences {
     ...
     */
    public static String getPreferredWeatherLocation(Context context) {SharedPreferences prefs = PreferenceManager
